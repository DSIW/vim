...
if !exists("g:EclimHome")
  ...
  let g:EclimHome = '/home/max/.eclipse/org.xmind.cathy.product_3.1.1_1461292772/plugins/org.eclim_1.6.3'
  if has('win32unix')
...
if !exists("g:EclimEclipseHome")
  " set at build/install time.
  let g:EclimEclipseHome = '/home/max/.eclipse/org.xmind.cathy.product_3.1.1_1461292772'
  if has('win32unix')
